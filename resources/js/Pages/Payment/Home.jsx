            ...
            renderCell: (params) => {
                ...
                return (
                    <button
                        ...
                        onClick={(e) => handleDelete(paymentId)}
                    >
                        Xóa
                    </button>
                );
    ...
    const handleDelete = (paymentId) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete("/admin/payments/" + paymentId).then((res) => {
    ...
    const notyf = new Notyf({
        ...
        types: [
            ...
            },
            {
                ...
                duration: 2000,
                dismissible: true,className: "notyf-error",
            },
            {
                type: "success",
                background: "green",
                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="form-group">
                                    ...
                                    <input onChange ={(e) =>setMethod(e.target.value)} name="method" className="form-control" type="text" />
                                </div>
                            </div>
                        </div>
