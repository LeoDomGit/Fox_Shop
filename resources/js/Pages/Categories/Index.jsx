...
function Index({ categories }) {
  ...
  const columns = [
    ...
    {
      field: 'created_at', headerName: 'Created at', valueGetter: (params) => formatCreatedAt(params)
    }
  ];
    ...
    <Layout>
      <>
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
          <label htmlFor="">Loại sản phẩm</label>
            <input type="text" className='form-control' placeholder='Tên loại sản phẩm' onChange={(e) => setCategory(e.target.value)} />
          <label htmlFor="">Thứ tự </label>

            <input type="number" className='form-control' placeholder='Thứ tự' onChange={(e) => setPosition(e.target.value)} />
          </Modal.Body>
          <Modal.Footer>
            <Button variant="secondary" onClick={handleClose}>
              Đóng
            </Button>
            <Button variant="primary text-light" disabled={category == '' || position ==0 ? true : false} onClick={(e) => submitCategory()}>
              Tạo mới
            </Button>
          </Modal.Footer>
        </Modal>
